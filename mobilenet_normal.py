...
def get_symbol(num_classes, **kwargs):
    ...
    conv_2 = Conv(conv_1, num_filter=64, kernel=(3, 3), pad=(1, 1), stride=(1, 1), name="conv_2") # 112
    #conv_2 = Conv(conv_2_dw, num_filter=64, kernel=(1, 1), pad=(0, 0), stride=(1, 1), name="conv_2") # 112

    conv_3 = Conv(conv_2, num_filter=128, kernel=(3, 3), pad=(1, 1), stride=(2, 2), name="conv_3") # 56
    #conv_3 = Conv(conv_3_dw, num_filter=128, kernel=(1, 1), pad=(0, 0), stride=(1, 1), name="conv_3") # 56

    conv_4 = Conv(conv_3, num_filter=128, kernel=(3, 3), pad=(1, 1), stride=(1, 1), name="conv_4") # 56
    #conv_4 = Conv(conv_4_dw, num_filter=128, kernel=(1, 1), pad=(0, 0), stride=(1, 1), name="conv_4") # 56

    conv_5 = Conv(conv_4, num_filter=256, kernel=(3, 3), pad=(1, 1), stride=(2, 2), name="conv_5") # 28
    #conv_5 = Conv(conv_5_dw, num_filter=256, kernel=(1, 1), pad=(0, 0), stride=(1, 1), name="conv_5") # 28

    conv_6 = Conv(conv_5, num_filter=256, kernel=(3, 3), pad=(1, 1), stride=(1, 1), name="conv_6") # 28
    #conv_6 = Conv(conv_6_dw, num_filter=256, kernel=(1, 1), pad=(0, 0), stride=(1, 1), name="conv_6") # 28

    conv_7 = Conv(conv_6, num_filter=512, kernel=(3, 3), pad=(1, 1), stride=(2, 2), name="conv_7") # 14
    #conv_7 = Conv(conv_7_dw, num_filter=512, kernel=(1, 1), pad=(0, 0), stride=(1, 1), name="conv_7") # 14

    conv_8 = Conv(conv_7, num_filter=512, kernel=(3, 3), pad=(1, 1), stride=(1, 1), name="conv_8") # 14
    #conv_8 = Conv(conv_8_dw, num_filter=512, kernel=(1, 1), pad=(0, 0), stride=(1, 1), name="conv_8") # 14

    conv_9 = Conv(conv_8, num_filter=512, kernel=(3, 3), pad=(1, 1), stride=(1, 1), name="conv_9") # 14
    #conv_9 = Conv(conv_9_dw, num_filter=512, kernel=(1, 1), pad=(0, 0), stride=(1, 1), name="conv_9") # 14

    conv_10 = Conv(conv_9, num_filter=512, kernel=(3, 3), pad=(1, 1), stride=(1, 1), name="conv_10") # 14
    #conv_10 = Conv(conv_10_dw, num_filter=512, kernel=(1, 1), pad=(0, 0), stride=(1, 1), name="conv_10") # 14

    conv_11 = Conv(conv_10, num_filter=512, kernel=(3, 3), pad=(1, 1), stride=(1, 1), name="conv_11") # 14
    #conv_11 = Conv(conv_11_dw, num_filter=512, kernel=(1, 1), pad=(0, 0), stride=(1, 1), name="conv_11") # 14

    conv_12 = Conv(conv_11, num_filter=512, kernel=(3, 3), pad=(1, 1), stride=(1, 1), name="conv_12") # 14
    #conv_12 = Conv(conv_12_dw, num_filter=512, kernel=(1, 1), pad=(0, 0), stride=(1, 1), name="conv_12") # 14

    conv_13 = Conv(conv_12, num_filter=1024, kernel=(3, 3), pad=(1, 1), stride=(2, 2), name="conv_13") # 7
    #conv_13 = Conv(conv_13_dw, num_filter=1024, kernel=(1, 1), pad=(0, 0), stride=(1, 1), name="conv_13") # 7

    conv_14 = Conv(conv_13, num_filter=1024, kernel=(3, 3), pad=(1, 1), stride=(1, 1), name="conv_14") # 7
    #conv_14 = Conv(conv_14_dw, num_filter=1024, kernel=(1, 1), pad=(0, 0), stride=(1, 1), name="conv_14") # 7
